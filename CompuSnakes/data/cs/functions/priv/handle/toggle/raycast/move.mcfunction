...
execute at @s[tag=cs_ray_no_sneak] align xyz unless block ~ ~ ~ #cs:air run summon armor_stand ~0.5 ~ ~0.5 {NoAI: 1b, NoGravity: 1b, NoBasePlate: 1b, Small: 1b, Invisible: 1b, Invulnerable: 1b, Tags: ["cs_toggle", "cs_just_placed"]}
