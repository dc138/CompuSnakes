...
execute as @s[scores={cs_uses_dummy=1}] run function cs:priv/handle/toggle/menu/sps
execute as @s[scores={cs_uses_dummy=1}] run function cs:priv/handle/toggle/menu/anticrash
